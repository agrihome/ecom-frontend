...
function CategoryBox({ name, svg, link   }: Category) {
    return <Link className="w-full h-auto hover:bg-[#DB4444] aspect-170/145 flex flex-col justify-center items-center border border-gray-400/80 rounded-sm stroke-gray-600 hover:stroke-white hover:text-white gap-1" href={link}>
...
const Categories = [
    {
        svg: <svg width="auto" height="auto" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_936_868)">
