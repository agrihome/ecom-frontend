...
export default function Footer() {
    return (
        <footer className="w-full px-5 sm:px-20 min-h-[440px] bg-black text-white flex flex-col sm:items-center sm:justify-center gap-16" >
            <section className="grid lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-8 text-base font-normal max-w-9xl pt-10 lg:pt-0">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-4 items-center relative">
                        <Image src="/images/qrcode.png" alt="QR Code" width={76} height={76} />

                        <Image src="/images/google.png" alt="Google Play" width={108} height={44} className="absolute -top-8 left-22" />
                        <Image src="/images/apple.png" alt="App Store" width={96} height={28} className="absolute top-2 left-24" />
                    </div>
            ...
            <p className="flex items-center gap-3 mx-auto w-max text-gray-600 stroke-gray-600" >
                <svg width="19" height="19" viewBox="0 0 19 19" fill="inherit" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.08333 17.4167C13.6857 17.4167 17.4167 13.6857 17.4167 9.08333C17.4167 4.48096 13.6857 0.75 9.08333 0.75C4.48096 0.75 0.75 4.48096 0.75 9.08333C0.75 13.6857 4.48096 17.4167 9.08333 17.4167Z" stroke="inherit" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M11.5833 7.23148C11.5833 7.23148 10.5539 5.75 8.83824 5.75C7.12255 5.75 5.75 7.23148 5.75 9.08333C5.75 10.9352 7.12255 12.4167 8.83824 12.4167C10.5539 12.4167 11.5833 10.9352 11.5833 10.9352" stroke="inherit" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
