  ...
  return (
    <div className="flex items-end gap-2">
      ...
      <div className="flex flex-col items-start">
        ...
        <span className="text-2xl font-bold">{formatTime(time.hours)}</span>
      </div>
      <span className="text-2xl font-bold text-[#DB4444] mb-1">:</span>
      <div className="flex flex-col items-start">
        <span className="text-xs text-gray-500">Minutes</span>
        <span className="text-2xl font-bold">{formatTime(time.minutes)}</span>
      </div>
      <span className="text-2xl font-bold text-[#DB4444] mb-1">:</span>
      <div className="flex flex-col items-start">
        <span className="text-xs text-gray-500">Seconds</span>
        <span className="text-2xl font-bold">{formatTime(time.seconds)}</span>
      </div>
    </div>
  );
}
