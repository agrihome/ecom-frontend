...
export default function ProductCardResponsive({
  ...
  return (
    <div className="relative w-full group">
      <div className="bg-[#F5F5F5] w-full aspect-[1.08] flex items-center justify-center rounded-md relative ">
        <Image
          src={imgUrl}
          alt={productName}
          className="object-cover w-[63.7%] h-auto"
        />
        <button className="block w-full bg-black opacity-0 group-hover:opacity-100 transition ease-in duration-200 text-white text-center py-2 absolute bottom-0 rounded-b-md">
          Add To Cart
        </button>
      </div>
