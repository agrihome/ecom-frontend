    ...
    <div className="relative w-full group">
      ...
      {isNew ? (
        ...
        discountPercent !== undefined && (
          <span className="w-[45px] sm:w-[56px] flex h-[22px] sm:h-[26px] absolute top-4 left-4 items-center justify-center bg-[#DB4444] rounded-md text-white text-[10px] sm:text-[12px]">
            {discountPercent}%
          </span>
        )
      )}
